#!/usr/bin/env python3
"""
Research Suite CLI — AI-Accelerated Scientific Research Assistant
...
def cmd_kg_trends(args):
    ...
    if not args.kg:
        print("❌ 需要先构建图谱: research kg-build --papers <file> --output kg.json")
        return
...
def cmd_config(args):
    ...
    if args.set_key:
        ...
        print("用法: research config set <key>=<value>")
